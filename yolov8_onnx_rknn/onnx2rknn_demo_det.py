...
# ONNX_MODEL = './yolov8x.onnx'
# RKNN_MODEL = './yolov8x.rknn'

ONNX_MODEL = './zhiguang_total.onnx'
RKNN_MODEL = './yolov8x_zhiguang_total.rknn'
...
CLASSES = ['cow1', 'cow2', 'sheep', 'fire', 'clothes']
...
if __name__ == '__main__':
    ...
    cv2.imwrite('./test_rknn_result_rzh.jpg', orig_img)
